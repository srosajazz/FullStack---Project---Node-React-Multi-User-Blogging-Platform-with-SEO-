...
var listSearch = function listSearch(params) {
  return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_1___default()("".concat(_config__WEBPACK_IMPORTED_MODULE_2__["API"], "/blogs/search"), {
    method: 'GET'
  }).then(function (response) {
    return response.json();
  })["catch"](function (err) {
...
//# sourceMappingURL=[slug].js.20fa49f7e3cba91c758b.hot-update.js.map